...
exports.createPosition = async (req, res) => {
  try {
    ...
    // Validation
    if (!name || seats === undefined || seats === null || !nominationOpens || !nominationCloses || !votingOpens || !votingCloses) {
    ...
    if (isNaN(nomOpen.getTime()) || isNaN(nomClose.getTime()) || isNaN(voteOpen.getTime()) || isNaN(voteClose.getTime())) {
    ...
    await logAudit({
      ...
      payload: { name, seats: seatsInt, nominationOpens, nominationCloses, votingOpens, votingCloses },
    });
