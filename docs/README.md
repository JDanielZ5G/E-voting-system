...
- **Font Sizes**: Responsive scaling (sm, md, lg, xl)
...
- **Cards**: White background (#FFFFFF), subtle borders (#E5E7EB), rounded corners
- **Buttons**: 
  - Primary: Blue (#4A6CF7) with white text
  - Secondary: Teal (#00C39A) with white text
  - Ghost: Transparent with text-secondary color
- **Inputs**: White background, primary focus rings, card-stroke borders
- **Sidebar**: White background, primary-light for active items
- **TopBar**: White background with card-stroke border
- **Icons**: Primary blue for main actions, muted-foreground for secondary
